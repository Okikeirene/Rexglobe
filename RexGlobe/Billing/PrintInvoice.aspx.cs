...
namespace RexLubs.Billing
{
    public partial class PrintInvoice : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string[] fields = { "ID" };
                //int CatID = Convert.ToInt32(Grid.GetDataRow(Convert.ToInt32(ID)));
                var prod = Convert.ToInt32(Grid.GetRowValues(Convert.ToInt32(visibleIndex.Value), fields));
                Viewer.Report = new InvoiceXtraReport(prod);
                isPrint.Value = "false";
