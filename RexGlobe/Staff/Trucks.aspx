<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin/SiteSuperAdmin.Master" AutoEventWireup="true" CodeBehind="Trucks.aspx.cs" Inherits="RexGlobe.Staff.Trucks" %>
...
<%--<asp:EntityDataSource ID="edsTransportationType" runat="server" ConnectionString="name=RexGlobeEntities" DefaultContainerName="RexGlobeEntities" EnableFlattening="False" EntitySetName="Transportation" OrderBy="it.ID" Select=" it.[ID],it.[TransportationType]">
    ...
    <asp:EntityDataSource ID="edsVehicleProvider" runat="server" ConnectionString="name=RexGlobeEntities" DefaultContainerName="RexGlobeEntities" EnableFlattening="False" EntitySetName="VechicleTypes" OrderBy="it.ID" Select=" it.[ID],it.[VehicleProvider]">
    </asp:EntityDataSource>--%>
