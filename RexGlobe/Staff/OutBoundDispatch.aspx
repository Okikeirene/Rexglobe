<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin/SiteSuperAdmin.Master" AutoEventWireup="true" CodeBehind="OutBoundDispatch.aspx.cs" Inherits="RexGlobe.Staff.OutBoundDispatch" %>
...
<dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlOutBound" KeyFieldName="In_Bound_ID">
...
<AdaptiveDetailLayoutProperties ColCount="1"></AdaptiveDetailLayoutProperties>
        ...
        <Templates>
            <EditForm>
                <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" Width="100%" DataSourceID="SqlOutBound" ClientInstanceName="formlayout" ColCount="2">
                    <Items>
...
<EditFormLayoutProperties ColCount="1"></EditFormLayoutProperties>
    ...
    <asp:SqlDataSource ID="SqlOutBound" runat="server" ConnectionString="<%$ ConnectionStrings:RexGlobeDB %>" DeleteCommand="DELETE FROM [Out_Bound_Dispatch] WHERE [Out_Bound_ID] = @Out_Bound_ID" InsertCommand="INSERT INTO [Out_Bound_Dispatch] ([QuantityID], [DispatchID], [VehicleID], [Region], [Route_Cities], [Dispatch_Date_Time], [BookingID], [WareHouseAgent], [BankStaffatDepo], [RexGlobeStaff], [NameofDepo], [CompanyName], [CompanyRep], [CreatedDate], [CreatedBy]) VALUES (@QuantityID, @DispatchID, @VehicleID, @Region, @Route_Cities, @Dispatch_Date_Time, @BookingID, @WareHouseAgent, @BankStaffatDepo, @RexGlobeStaff, @NameofDepo, @CompanyName, @CompanyRep, @CreatedDate, @CreatedBy)" SelectCommand="SELECT * FROM [Out_Bound_Dispatch]" UpdateCommand="UPDATE [Out_Bound_Dispatch] SET [QuantityID] = @QuantityID, [DispatchID] = @DispatchID, [VehicleID] = @VehicleID, [Region] = @Region, [Route_Cities] = @Route_Cities, [Dispatch_Date_Time] = @Dispatch_Date_Time, [BookingID] = @BookingID, [WareHouseAgent] = @WareHouseAgent, [BankStaffatDepo] = @BankStaffatDepo, [RexGlobeStaff] = @RexGlobeStaff, [NameofDepo] = @NameofDepo, [CompanyName] = @CompanyName, [CompanyRep] = @CompanyRep, [CreatedDate] = @CreatedDate, [CreatedBy] = @CreatedBy WHERE [Out_Bound_ID] = @Out_Bound_ID">
        <DeleteParameters>
            <asp:Parameter Name="Out_Bound_ID" Type="Int32" />
        </DeleteParameters>
        <InsertParameters>
