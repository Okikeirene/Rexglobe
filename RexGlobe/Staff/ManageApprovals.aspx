<%@ Page Language="C#" MasterPageFile="~/SuperAdmin/SiteSuperAdmin.Master" AutoEventWireup="true" CodeBehind="ManageApprovals.aspx.cs" Inherits="RexLubs.Staff.ManageApprovals" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    ...
    <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlApproval" KeyFieldName="ID">
        ...
        <Columns>
            ...
            <dx:GridViewDataComboBoxColumn FieldName="FinanceApproval"   VisibleIndex="20">
            <PropertiesComboBox DataSourceID="SqlProcurementDescritpion" TextField="Response"  ValueField="Response" >                                                     
            ...
            <dx:GridViewDataComboBoxColumn Caption="OperatonsApproval" FieldName="HeadOfOperatonsApproval"   VisibleIndex="21">
            <PropertiesComboBox DataSourceID="SqlProcurementDescritpion" TextField="Response"  ValueField="Response" >                                                     
            ...
            <dx:GridViewDataComboBoxColumn FieldName="CreditRiskApproval"   VisibleIndex="22">
            <PropertiesComboBox DataSourceID="SqlProcurementDescritpion" TextField="Response"  ValueField="Response" >                                                     
            ...
            <dx:GridViewDataComboBoxColumn FieldName="DirectorApproval"   VisibleIndex="23">
            <PropertiesComboBox DataSourceID="SqlProcurementDescritpion" TextField="Response"  ValueField="Response" >                                                     
