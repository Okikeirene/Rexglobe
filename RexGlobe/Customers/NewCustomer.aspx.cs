    ...
    public partial class NewCustomer : System.Web.UI.Page
    {
        ...
        protected void ASPxButtonSubmit_Click(object sender, EventArgs e)
        {
            ...
            Customer _request = new Customer()
            {
                ...
                SuppliersList = (string)ASPxFormLayout1.GetNestedControlValueByFieldName("SuppliersList"),
                TopFiveclients = (string)ASPxFormLayout1.GetNestedControlValueByFieldName("TopFiveclients"),
                RemitMoneyForSanctionedCountry = (string)ASPxFormLayout1.GetNestedControlValueByFieldName("RemitMoneyForSanctionedCountry"),
                PerformThirdPartyBusinessTransaction = (string)ASPxFormLayout1.GetNestedControlValueByFieldName("PerformThirdPartyBusinessTransaction"),
                AnySubsidiaryInSanctionCountry = (string)ASPxFormLayout1.GetNestedControlValueByFieldName("CountryOfProductTrade"),
                CountryOfProductTrade = (string)ASPxFormLayout1.GetNestedControlValueByFieldName("CountryOfProductTrade"),
                CountryImportedGoodsandServices = (string)ASPxFormLayout1.GetNestedControlValueByFieldName("CountryImportedGoodsandServices"),
                CountryExportedGoodsandServices = (string)ASPxFormLayout1.GetNestedControlValueByFieldName("CountryExportedGoodsandServices"),
                CountryTransitOfGoodsandService = (string)ASPxFormLayout1.GetNestedControlValueByFieldName("CountryTransitOfGoodsandService"),
                YourCustomers = (string)ASPxFormLayout1.GetNestedControlValueByFieldName("YourCustomers"),
                YourProducts = (string)ASPxFormLayout1.GetNestedControlValueByFieldName("YourProducts"),
                TotalsalesOfClients = (decimal)ASPxFormLayout1.GetNestedControlValueByFieldName("TotalsalesOfClients"),
                TotalPurchasesofClient = (decimal)ASPxFormLayout1.GetNestedControlValueByFieldName("TotalPurchasesofClient"),
                TotalAssetsoftheClient = (decimal)ASPxFormLayout1.GetNestedControlValueByFieldName("TotalAssetsoftheClient"),
                TotalOperatingIncomeofClient = (decimal)ASPxFormLayout1.GetNestedControlValueByFieldName("TotalOperatingIncomeofClient"),
                LicenseforConductedTransactions = (string)ASPxFormLayout1.GetNestedControlValueByFieldName("LicenseforConductedTransactions"),
                TransactwithSanctionedCountries = (string)ASPxFormLayout1.GetNestedControlValueByFieldName("TransactwithSanctionedCountries"),
                BanksUsedtoTransactwithSanctionedCountries = (string)ASPxFormLayout1.GetNestedControlValueByFieldName("BanksUsedtoTransactwithSanctionedCountries"),
                PlanToGrowMaintainorReduceBusinesswithSanctionCountries = (string)ASPxFormLayout1.GetNestedControlValueByFieldName("PlanToGrowMaintainorReduceBusinesswithSanctionCountries"),
