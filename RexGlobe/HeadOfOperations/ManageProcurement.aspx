<%@ Page Title="" Language="C#" MasterPageFile="~/HeadOfOperations/Operations.Master" AutoEventWireup="true" CodeBehind="ManageProcurement.aspx.cs" Inherits="RexLubs.HeadOfOperations.ManageProcurement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    ...
    <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlProcurement" KeyFieldName="ID" Width="100%">
        ...
        <Columns>
            ...
            <dx:GridViewDataComboBoxColumn Caption="Compliance" FieldName="Compliance" Visible="false"   VisibleIndex="12">
