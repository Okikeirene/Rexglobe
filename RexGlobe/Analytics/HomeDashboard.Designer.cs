namespace RexLubs
{
    partial class HomeDashboard
    {
        ...
        private void InitializeComponent()
        {
            ...
            // 
            measure1.DataMember = "ApprovePickUprequest";
            ...
            this.cardDashboardApprovedPickUpRequests.Cards.AddRange(new DevExpress.DashboardCommon.Card[] {
            card1});
            this.cardDashboardApprovedPickUpRequests.ComponentName = "cardDashboardApprovedPickUpRequests";
            this.cardDashboardApprovedPickUpRequests.DataItemRepository.Clear();
            this.cardDashboardApprovedPickUpRequests.DataItemRepository.Add(measure1, "DataItem0");
            this.cardDashboardApprovedPickUpRequests.DataMember = "Query";
            this.cardDashboardApprovedPickUpRequests.DataSource = this.dashboardSqlDataSource6;
            this.cardDashboardApprovedPickUpRequests.InteractivityOptions.IgnoreMasterFilters = false;
    ...
    "CBOYW1lPSJwZW5kaW5nIiBUeXBlPSJJbnQzMiIgLz48L1ZpZXc+PC9EYXRhU2V0Pg==";
            ...
            customSqlQuery6.Sql = "SELECT SUM([Amount]) AS TOTALAMOUNT FROM [RexGlobe].[dbo].[Payments] where [Creat" +
    "edDate] = GETDATE();";
